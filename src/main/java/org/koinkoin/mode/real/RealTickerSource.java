...
public class RealTickerSource implements TickerSource {
	...
	public RealTickerSource(ExchangeDescriptor desc) {
	...
	public List<Ticker> tickers() throws Exception {
		...
		TickerFactory tickerFactory = descriptor.getTickerFactory();

		if (tickerFactory != null) {
			prices = tickerFactory.getTickers(descriptor.getTradingCurrencyPairs());
		} else {
